  ...
  return [
    {
      ...
      stockName: '삼성전자',
      hypothesis: '종목명을 썸네일 좌상단에 크게 넣으면 클릭률이 오른다',
      variantA: '기존 썸네일 (얼굴 + 차트)',
      variantB: '종목명 대형 텍스트 + 빨간 화살표',
      metric: 'CTR (유튜브 스튜디오 노출 클릭률)',
      startedOn: addDaysToYmd(today, -10),
      endedOn: addDaysToYmd(today, -3),
      winner: 'b',
      learning: '종목명 텍스트가 크면 CTR 5.1% → 7.4%. 다만 얼굴이 없으면 평균 시청 지속시간은 소폭 하락.',
      createdBy: null,
      createdByName: '샘플',
      createdAt: nowIso,
      updatedAt: nowIso
    ...
    },
    {
      ...
      winner: 'tie',
      learning: '시청 비율 차이 1%p 미만. 숏폼은 인트로보다 자막 크기 영향이 더 큰 것으로 보임.',
      createdBy: null,
      createdByName: '샘플',
      createdAt: nowIso,
      updatedAt: nowIso
