...
export const MENU_DEFINITIONS = [
  { key: 'creator_dashboard', label: '대시보드', href: '/v2/creator/dashboard', audience: 'creator' },
  { key: 'creator_videos', label: '영상등록', href: '/v2/creator/videos', audience: 'creator' },
  { key: 'admin_dashboard', label: '대시보드 - 관리자', href: '/v2/admin/dashboard', audience: 'admin' },
  { key: 'admin_channels', label: '채널 현황 - 관리자', href: '/v2/admin/channels', audience: 'admin' },
  { key: 'admin_users', label: '직급관리 - 관리자', href: '/v2/admin/users', audience: 'admin' },
  { key: 'admin_attendance', label: '근태관리 - 관리자', href: '/v2/admin/attendance', audience: 'admin' },
  { key: 'admin_menu_permissions', label: '메뉴권한 - 관리자', href: '/v2/admin/menu-permissions', audience: 'admin' },
  { key: 'admin_youtube_accounts', label: '유튜브 계정 관리 - 관리자', href: '/v2/admin/youtube-accounts', audience: 'admin' }
] as const
...
export function getFirstAllowedHref(menuKeys: string[], fallbackRoleType?: string) {
  ...
  if (fallbackRoleType && ['super_admin', 'admin'].includes(fallbackRoleType)) return '/v2/admin/dashboard'
  return '/v2/creator/dashboard'
}
